...
public class TambahTeman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_teman2);
    ...
    public EditText getEdNama() {
        return edNama;
    }

    public void setEdNama(EditText edNama) {
        this.edNama = edNama;
    }

    public EditText getEdTelpon() {
        return edTelpon;
    }

    public void setEdTelpon(EditText edTelpon) {
        this.edTelpon = edTelpon;
    }
}